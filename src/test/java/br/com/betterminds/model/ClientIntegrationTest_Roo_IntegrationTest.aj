...
import br.com.betterminds.model.ClientDataOnDemand;
import br.com.betterminds.model.ClientIntegrationTest;
...
privileged aspect ClientIntegrationTest_Roo_IntegrationTest {
    ...
    public void ClientIntegrationTest.testFlush() {
        ...
        obj.flush();
        Assert.assertTrue("Version for 'Client' failed to increment on flush directive", (currentVersion != null && obj.getVersao() > currentVersion) || !modified);
    }
    ...
    public void ClientIntegrationTest.testMergeUpdate() {
        ...
        Assert.assertTrue("Version for 'Client' failed to increment on merge and flush directive", (currentVersion != null && obj.getVersao() > currentVersion) || !modified);
    }
