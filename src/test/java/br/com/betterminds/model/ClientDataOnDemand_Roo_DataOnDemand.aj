...
privileged aspect ClientDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    EnderecoDataOnDemand ClientDataOnDemand.enderecoDataOnDemand;
    
    @Autowired
    PessoaDataOnDemand ClientDataOnDemand.pessoaDataOnDemand;
    
    @Autowired
    TelefoneDataOnDemand ClientDataOnDemand.telefoneDataOnDemand;
