...
import br.com.betterminds.model.UsuarioDataOnDemand;
import br.com.betterminds.model.UsuarioIntegrationTest;
...
privileged aspect UsuarioIntegrationTest_Roo_IntegrationTest {
    ...
    public void UsuarioIntegrationTest.testFlush() {
        ...
        obj.flush();
        Assert.assertTrue("Version for 'Usuario' failed to increment on flush directive", (currentVersion != null && obj.getVersao() > currentVersion) || !modified);
    }
    ...
    public void UsuarioIntegrationTest.testMergeUpdate() {
        ...
        Assert.assertTrue("Version for 'Usuario' failed to increment on merge and flush directive", (currentVersion != null && obj.getVersao() > currentVersion) || !modified);
    }
